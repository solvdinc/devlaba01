    ...
    <div className="avatar" onClick={callback}>
      ...
      <svg className={'avatar-refresh'} height="512" viewBox="0 0 64 64" width="512" xmlns="http://www.w3.org/2000/svg">
        <g id="arrow-refresh-transfer-user_interface-interface"
          ...
          <path d="m44 25h16v-16a2 2 0 0 0 -4 0v5.34a1 1 0 0 1 -1.793.608 28 28 0 0 0 -49.853 12.582 3.006 3.006 0 0 0 2.971 3.47 3.029 3.029 0 0 0 2.966-2.588 21.993 21.993 0 0 1 39.751-8.983 1 1 0 0 1 -.822 1.571h-5.22a2 2 0 0 0 0 4z"/></g></svg>
    </div>
  );
};
